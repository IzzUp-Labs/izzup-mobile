...
class _RegisterInformationsState extends State<RegisterInformations> {
  ...
  void modifyRegistrationAccount() {
    if (widget.accountType == RegisterAccountType.jobSeeker) {
      ...
      Globals.tempEmployer.dateOfBirth = _dateController.text.ddMmYyyyToDateTime;
    }
  }
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText: _isFirstNameValid ? null : 'Invalid first name',
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText: _isLastNameValid ? null : 'Invalid first name',
                    ),
                  ),
                ),
                Padding(
